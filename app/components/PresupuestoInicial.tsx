...
const COLORES: Record<string, string> = {
  ...
  acondicionamiento: "bg-orange-100 text-orange-700",
};
...
export default function PresupuestoInicial({ ideaElegida, capital, zona, localPropio }: Props) {
  ...
  const inputClass = "bg-slate-50 border border-slate-200 rounded-lg px-2 py-1.5 text-xs text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400/30 focus:border-blue-400 transition";
      ...
      <div className="px-6 py-5 flex flex-col gap-4">
        {!generado && (
          <button onClick={generar} disabled={cargando}
            className="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold py-3 rounded-xl transition disabled:opacity-50 flex items-center justify-center gap-2">
            {cargando ? (
